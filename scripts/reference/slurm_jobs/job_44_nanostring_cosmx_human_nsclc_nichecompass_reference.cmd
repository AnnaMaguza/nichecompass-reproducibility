#!/bin/bash
#SBATCH -J 44_nanostring_cosmx_human_nsclc_nichecompass_reference
#SBATCH -o logs/out_44_nanostring_cosmx_human_nsclc_nichecompass_reference.txt
#SBATCH -e logs/err_44_nanostring_cosmx_human_nsclc_nichecompass_reference.txt
#SBATCH -t 24:00:00
#SBATCH -p gpu_p
#SBATCH -c 8
#SBATCH --gres=gpu:1
