#!/bin/bash
#SBATCH -J 4_nanostring_cosmx_human_nsclc_nichecompass_reference
#SBATCH -o logs/out_4_nanostring_cosmx_human_nsclc_nichecompass_reference.txt
#SBATCH -e logs/err_4_nanostring_cosmx_human_nsclc_nichecompass_reference.txt
#SBATCH -t 24:00:00
#SBATCH -p gpu_p
#SBATCH -c 6
#SBATCH --gres=gpu:1
