#!/bin/bash
#SBATCH -J 43_8_nanostring_cosmx_human_nsclc_nichecompass_reference_query
#SBATCH -o logs/out_43_8_nanostring_cosmx_human_nsclc_nichecompass_reference_query.txt
#SBATCH -e logs/err_43_8_nanostring_cosmx_human_nsclc_nichecompass_reference_query.txt
#SBATCH -t 24:00:00
#SBATCH -p gpu_p
#SBATCH -c 8
#SBATCH --gres=gpu:1
